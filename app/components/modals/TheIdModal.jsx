...
const TheIdModal = ({
    ...
    const props = {
        ...
        beforeUpload: (file) => {
            ...
            if (!isImage) {
                message.error(`${file.name} ${t('content.modal.upload_file.form.warning')}`);
    ...
    return (
        <>
            ...
            >
                <div>
                    <div className='desc'>
                        <h4>{t('content.modal.upload_file.title')}</h4>
                        <p>{t('content.modal.upload_file.sub_title.sub_1')}</p>
                        <p>{t('content.modal.upload_file.sub_title.sub_2')}</p>
                        <p>{t('content.modal.upload_file.sub_title.sub_3')}</p>
                    </div>
                    ...
                    <Form
                        ...
                        form={theId}
                    >
                        <Dragger {...props} className='upload-id'>
                            <p className="ant-upload-drag-icon">
                                <CloudUploadOutlined size={'small'} />
                            </p>
                            <p className="ant-upload-text">{t('content.modal.upload_file.form.file')}</p>
                        </Dragger>
